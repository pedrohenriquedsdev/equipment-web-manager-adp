...
public class ChamadoController : Controller
{
    ...
    public ActionResult Cadastrar()
    {
        ...
        CadastrarChamadoViewModels cadastrarVm = new CadastrarChamadoViewModels(string.Empty, null, string.Empty);

        return View(cadastrarVm);
    }

    [HttpPost]
    public ActionResult Cadastrar(CadastrarChamadoViewModels cadastrarVm)
    {
    ...
    public ActionResult Editar(string id)
    {
        ...
        EditarChamadoViewModels editarChamadoVm = new EditarChamadoViewModels(
            chamado.Id,
            chamado.Titulo,
            chamado.Descricao,
    ...
    [HttpPost]
    public ActionResult Editar(EditarChamadoViewModels editarVm)
    {
        Equipamento? equipamento =
    ...
    public ActionResult Excluir(string id)
    {
        ...
        ExcluirChamadoViewModels excluirVm = new ExcluirChamadoViewModels(
            chamado.Id,
            chamado.Titulo,
            chamado.Descricao,
    ...
    [HttpPost]
    [ActionName("Excluir")]
    public ActionResult ExcluirConfirmado(ExcluirChamadoViewModels excluirVm)
    {
